        ...
        >
          ...
          <div className="grid grid-cols-2 h-full">
            ...
            <AnimatePresence mode="wait" initial={false}>
              <StepPreview
                key={currentStep}
                step={steps[currentStep] || { title: "", short_description: "", full_description: "" } as Step}
                direction={direction}
              />
            </AnimatePresence>
          </div>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-4 space-y-4 pb-32">
              ...
              <div className="relative aspect-[16/9] ring-2 ring-border ring-offset-8 ring-offset-background rounded-lg overflow-hidden">
                <StepPreview step={steps[currentStep] || { title: "", short_description: "", full_description: "" } as Step} direction={direction} />
              </div>
