"use client";
import {Table,TableHeader,TableBody,TableFooter,TableHead,TableRow,TableCell,TableCaption,} from "@workspace/ui/components/table"
...
export const FilesView = () => {
    ...
    const {topElementRef, handleLoadMore, canLoadMore, isLoadingMore,isLoadingFirstPage} = useInfiniteScroll({status: files.status, loadMore: files.loadMore,loadSize: 10});
    return (
        <>
            ...
            <div className="mx-auto w-full max-w-screen-md">
                ...
                <div className="mt-8 rounded=lg border bg-background">
                    <div className="flex items-center justify-end border-b px-6 py-4">
                        <Button onClick={()=>setUploadDialogOpen(true)}>Add New</Button>
                    </div>
                    <Table>
                        <TableHeader>
                            <TableRow>
                                        ...
                                        <TableCell className="px-6 py-4 ">
                                          <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem className="text-destructive flex items-center gap-1 w-fit" onClick={()=>handleDeleteClick(file)}>
