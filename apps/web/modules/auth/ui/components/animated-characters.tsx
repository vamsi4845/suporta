...
export function AnimatedCharactersWrapper({ children }: { children: React.ReactNode }) {
  const [mouseX, setMouseX] = useState<number>(0);
  const [mouseY, setMouseY] = useState<number>(0);
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px]">
          ...
          <div className="relative" style={{ width: '550px', height: '400px' }}>
            ...
            >
              ...
              >
                <Pupil size={12} maxDistance={5} pupilColor="#2D2D2D" forceLookX={undefined} forceLookY={undefined} />
                <Pupil size={12} maxDistance={5} pupilColor="#2D2D2D" forceLookX={undefined} forceLookY={undefined} />
              </div>
            </div>
...
export default AnimatedCharactersWrapper;
